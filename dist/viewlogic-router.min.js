...
${r}`),s}async createVueComponent(e){let t=`component_${e}`,r=this.router.cacheManager?.get(t);if(r)return r;let s=await this.loadScript(e),i=this.router,a=this.config.environment==="production",o,n=null;if(a)o=s.template||this.generateDefaultTemplate(e);else{let h=[this.loadTemplate(e)];this.config.useLayout&&s.layout!==null?h.push(this.loadLayout(s.layout||this.config.defaultLayout)):h.push(Promise.resolve(null));let[u,d]=await Promise.all(h);o=u,n=d,n&&(o=this.mergeLayoutWithTemplate(e,n,o))}let l={};if(this.componentLoader)try{let h=null;if(!a){let u=s.layout||this.config.defaultLayout;h=this.componentLoader.getComponentNames(o,n,u),this.log("debug",`[DEVELOPMENT] Discovered components for route '${e}':`,h)}l=await this.componentLoader.loadAllComponents(h),this.log("debug",`Components loaded successfully for route: ${e}`)}catch(h){this.log("warn",`Component loading failed for route '${e}', continuing without components:`,h.message),l={}}let g={...s,name:s.name||this.toPascalCase(e),template:o,components:l,data(){return{...s.data?s.data():{},currentRoute:e,$query:i.queryManager?.getQueryParams()||{},$params:i.queryManager?.getRouteParams()||{},$lang:(()=>{try{return i.i18nManager?.getCurrentLanguage()||i.config.i18nDefaultLanguage||i.config.defaultLanguage||"ko"}catch(d){return i.errorHandler&&i.errorHandler.warn("RouteLoader","Failed to get current language:",d),i.config.defaultLanguage||"ko"}})(),$dataLoading:!1}},computed:{...s.computed||{},params(){return i.queryManager?.getAllParams()||{}}},async mounted(){this.$api=i.routeLoader.apiHandler.bindToComponent(this),this.$state=i.stateHandler,s.mounted&&await s.mounted.call(this),s.dataURL&&await this.fetchData(),await this.$nextTick(),i.routeLoader.formHandler.bindAutoForms(this)},methods:{...s.methods,navigateTo:(h,u)=>i.navigateTo(h,u),getCurrentRoute:()=>i.getCurrentRoute(),getParams:()=>i.queryManager?.getAllParams()||{},getParam:(h,u)=>i.queryManager?.getParam(h,u),$t:(h,u)=>{try{return i.i18nManager?.t(h,u)||h}catch(d){return i.errorHandler&&i.errorHandler.warn("RouteLoader","i18n translation failed, returning key:",d),h}},isAuth:()=>i.authManager?.isAuthenticated()||!1,logout:()=>i.authManager?i.navigateTo(i.authManager.logout()):null,getToken:()=>i.authManager?.getAccessToken()||null,setToken:(h,u)=>i.authManager?.setAccessToken(h,u)||!1,getLanguage:()=>i.i18nManager?.getCurrentLanguage()||i.config.defaultLanguage||"ko",setLanguage:h=>i.i18nManager?.setLanguage(h),log:(h,...u)=>{i.errorHandler&&i.errorHandler.log(h,`[${e}]`,...u)},async fetchData(h=null){let u=h||s.dataURL;if(!u)return null;this.$dataLoading=!0;try{if(typeof u=="string"){let d=await i.routeLoader.apiHandler.fetchData(u,this);return Object.assign(this,d),this.$emit("data-loaded",d),d}else if(typeof u=="object"){let{results:d,errors:R}=await i.routeLoader.apiHandler.fetchMultipleData(u,this);return Object.assign(this,d),Object.keys(d).length>0&&this.$emit("data-loaded",d),Object.keys(R).length>0&&this.$emit("data-error",R),d}return null}catch(d){throw i.errorHandler&&i.errorHandler.warn("RouteLoader",`Failed to fetch data for ${e}:`,d),this.$emit("data-error",d),d}finally{this.$dataLoading=!1}}},_routeName:e};return this.router.cacheManager?.set(t,g),g}toPascalCase(e){return e.split(/[-_\s]+/).map(t=>t.charAt(0).toUpperCase()+t.slice(1).toLowerCase()).join("")}generateDefaultTemplate(e){return`<div class="route-${e.replace(/\//g,"-")}"><h1>Route: ${e}</h1></div>`}log(e,...t){this.router?.errorHandler&&this.router.errorHandler.log(e,"RouteLoader",...t)}destroy(){this.formHandler&&(this.formHandler.destroy(),this.formHandler=null),this.apiHandler&&(this.apiHandler.destroy(),this.apiHandler=null),this.componentLoader&&(this.componentLoader.dispose(),this.componentLoader=null),this.log("debug","RouteLoader destroyed"),this.router=null}};var C=class{constructor(e,t={}){this.config={logLevel:t.logLevel||"info",environment:t.environment||"development"},this.router=e,this.logLevels={error:0,warn:1,info:2,debug:3},this.log("debug","ErrorHandler","ErrorHandler initialized with config:",this.config)}async handleRouteError(e,t){let r=500,s="\uD398\uC774\uC9C0\uB97C \uB85C\uB4DC\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.";this.debug("ErrorHandler","\uC5D0\uB7EC \uC0C1\uC138:",t.message,t.name),t.message.includes("not found")||t.message.includes("404")||t.message.includes("Failed to resolve")||t.message.includes("Failed to fetch")||t.name==="TypeError"&&t.message.includes("resolve")?(r=404,s=`'${e}' \uD398\uC774\uC9C0\uB97C \uCC3E\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.`):t.message.includes("network")&&!t.message.includes("not found")?(r=503,s="\uB124\uD2B8\uC6CC\uD06C \uC5F0\uACB0\uC744 \uD655\uC778\uD574 \uC8FC\uC138\uC694."):(t.message.includes("permission")||t.message.includes("403"))&&(r=403,s="\uD398\uC774\uC9C0\uC5D0 \uC811\uADFC\uD560 \uAD8C\uD55C\uC774 \uC5C6\uC2B5\uB2C8\uB2E4."),this.debug("ErrorHandler",`\uC5D0\uB7EC \uCF54\uB4DC \uACB0\uC815: ${r} (\uB77C\uC6B0\uD2B8: ${e})`),this.reportError(e,t,r);try{r===404?await this.load404Page():await this.loadErrorPage(r,s)}catch(i){this.error("ErrorHandler","\uC5D0\uB7EC \uD398\uC774\uC9C0 \uB85C\uB529 \uC2E4\uD328:",i),this.showFallbackErrorPage(r,s)}}async load404Page(){try{this.info("ErrorHandler","Loading 404 page...");let e=await this.createVueComponent("404");await this.renderComponentWithTransition(e,"404"),this.info("ErrorHandler","404 page loaded successfully")}catch(e){this.error("ErrorHandler","404 page loading failed:",e),this.showFallbackErrorPage("404","\uD398\uC774\uC9C0\uB97C \uCC3E\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.")}}async loadErrorPage(e,t){try{this.info("ErrorHandler",`Loading error page for ${e}...`);let r=await this.createErrorComponent(e,t);await this.renderComponentWithTransition(r,"error"),this.info("ErrorHandler",`Error page ${e} loaded successfully`)}catch(r){this.error("ErrorHandler",`Error page ${e} loading failed:`,r),this.showFallbackErrorPage(e,t)}}async createErrorComponent(e,t){try{let r=await this.createVueComponent("error");return{...r,data(){return{...r.data?r.data():{},errorCode:e,errorMessage:t,showRetry:!0,showGoHome:!0}}}}catch(r){throw this.error("ErrorHandler","Error component load failed:",r),new Error(`Cannot load error page: ${r.message}`)}}showFallbackErrorPage(e,t){let r=document.getElementById("app");if(!r)return;let s=`<div style="text-align:center;padding:2rem;font-family:sans-serif"><h1>${e}</h1><p>${t}</p><button onclick="location.reload()">Retry</button></div>`;r.innerHTML=s,this.info("ErrorHandler",`Fallback error page displayed for ${e}`)}reportError(e,t,r){let s={route:e,errorCode:r,errorMessage:t.message,stack:t.stack,url:window.location.href,userAgent:navigator.userAgent,timestamp:new Date().toISOString(),routerConfig:{environment:this.router?.config?.environment||"unknown",mode:this.router?.config?.mode||"unknown"}};this.error("ErrorHandler","\uB77C\uC6B0\uD130 \uC5D0\uB7EC \uB9AC\uD3EC\uD2B8:",s)}async createVueComponent(e){if(this.router.routeLoader)return await this.router.routeLoader.createVueComponent(e);throw new Error("RouteLoader not available")}async renderComponentWithTransition(e,t){if(this.router.renderComponentWithTransition)return await this.router.renderComponentWithTransition(e,t);throw new Error("Render function not available")}log(e,t,...r){(typeof e!="string"||!this.logLevels.hasOwnProperty(e))&&(r=[t,...r],t=e,e="info");let s=this.logLevels[this.config.logLevel]||this.logLevels.info,i=this.logLevels[e]||this.logLevels.info;if(i>s||this.config.environment==="production"&&i>this.logLevels.warn)return;let a=t?`[${t}]`:"[ViewLogic]",o=new Date().toISOString().substring(11,23);switch(e){case"error":console.error(`${o} ${a}`,...r);break;case"warn":console.warn(`${o} ${a}`,...r);break;case"info":console.info(`${o} ${a}`,...r);break;case"debug":console.log(`${o} ${a}`,...r);break;default:console.log(`${o} ${a}`,...r)}}error(e,...t){this.log("error",e,...t)}warn(e,...t){this.log("warn",e,...t)}info(e,...t){this.log("info",e,...t)}debug(e,...t){this.log("debug",e,...t)}destroy(){this.router=null,this.info("ErrorHandler","ErrorHandler destroyed")}};var $=class{constructor(e){this.router=e,this.state={},this.listeners=new Map,this.log("debug","StateHandler initialized")}log(e,...t){this.router?.errorHandler&&this.router.errorHandler.log(e,"StateHandler",...t)}set(e,t){let r=this.state[e];return this.state[e]=t,this.emitChange(e,t,r),this.log("debug",`State set: ${e}`,t),t}get(e,t=void 0){let r=this.state.hasOwnProperty(e)?this.state[e]:t;return this.log("debug",`State get: ${e}`,r),r}has(e){return this.state.hasOwnProperty(e)}delete(e){if(this.has(e)){let t=this.state[e];return delete this.state[e],this.emitChange(e,void 0,t),this.log("debug",`State deleted: ${e}`),!0}return!1}clear(){let e=Object.keys(this.state);return this.state={},e.forEach(t=>{this.emitChange(t,void 0,this.state[t])}),this.log("debug","All state cleared"),e.length}update(e){if(!e||typeof e!="object"){this.log("warn","Invalid updates object provided");return}Object.entries(e).forEach(([t,r])=>{this.set(t,r)})}getAll(){return{...this.state}}watch(e,t){this.listeners.has(e)||this.listeners.set(e,[]),this.listeners.get(e).push(t),this.log("debug",`Watcher added for: ${e}`)}unwatch(e,t){if(this.listeners.has(e)){let r=this.listeners.get(e),s=r.indexOf(t);s>-1&&(r.splice(s,1),this.log("debug",`Watcher removed for: ${e}`))}}emitChange(e,t,r){this.listeners.has(e)&&this.listeners.get(e).forEach(s=>{try{s(t,r,e)}catch(i){this.log("error","State watcher error:",i)}})}getStats(){return{stateCount:Object.keys(this.state).length,watcherCount:Array.from(this.listeners.values()).reduce((e,t)=>e+t.length,0),keys:Object.keys(this.state)}}destroy(){this.state={},this.listeners.clear(),this.log("debug","StateHandler destroyed")}};var T=class{constructor(e={}){this.version=e.version||"1.0.0",this.config=this._buildConfig(e),this.currentHash="",this.currentVueApp=null,this.previousVueApp=null,this.transitionInProgress=!1,this.progressBarTimer=null,this.progressBarElement=null,this.isReady=!1,this.readyPromise=null,this._boundHandleRouteChange=this.handleRouteChange.bind(this),this.readyPromise=this.initialize()}_buildConfig(e){let t=window.location.origin,s={...{basePath:"/",srcPath:"/src",mode:"hash",cacheMode:"memory",cacheTTL:3e5,maxCacheSize:50,useLayout:!0,defaultLayout:"default",environment:"development",routesPath:"/routes",enableErrorReporting:!0,useI18n:!1,defaultLanguage:"ko",i18nPath:"/i18n",logLevel:"info",apiBaseURL:"",requestTimeout:3e4,uploadTimeout:3e5,authEnabled:!1,loginRoute:"login",protectedRoutes:[],protectedPrefixes:[],publicRoutes:["login","register","home"],checkAuthFunction:null,redirectAfterLogin:"home",authCookieName:"authToken",authStorage:"localStorage"},...e};return s.srcPath=this.resolvePath(s.srcPath,s.basePath),s.routesPath=this.resolvePath(s.routesPath,s.basePath),s.i18nPath=this.resolvePath(s.i18nPath,s.basePath),s}combinePaths(e,t){if(!e||e==="/")return t.replace(/\/+/g,"/");let r=e.endsWith("/")?e.slice(0,-1):e,s=t.startsWith("/")?t:`/${t}`;return`${r}${s}`.replace(/\/+/g,"/")}resolvePath(e,t=null){t===null&&(t=this.config?.basePath||"/");let r=window.location.origin;if(e.startsWith("http"))return e;if(e.startsWith("/")){let o=this.combinePaths(t,e);return`${r}${o}`}let s=window.location.pathname,i=s.endsWith("/")?s:s.substring(0,s.lastIndexOf("/")+1),a=this.combinePaths(i,e);return`${r}${a}`}log(e,...t){this.errorHandler&&this.errorHandler.log(e,"Router",...t)}async initialize(){try{if(this.cacheManager=new p(this,this.config),this.stateHandler=new $(this),this.routeLoader=new L(this,this.config),this.queryManager=new y(this),this.errorHandler=new C(this,this.config),this.config.useI18n)try{this.i18nManager=new f(this,this.config),this.i18nManager.initPromise&&await this.i18nManager.initPromise,this.log("info","I18nManager initialized successfully")}catch(e){this.log("warn","I18nManager initialization failed, continuing without i18n:",e.message),this.i18nManager=null,this.config.useI18n=!1}this.config.authEnabled&&(this.authManager=new m(this,this.config)),this._createProgressBar(),this.isReady=!0,this.init()}catch(e){this.log("error","Router initialization failed:",e),this.isReady=!0,this.init()}}async waitForReady(){return this.isReady?!0:(this.readyPromise&&await this.readyPromise,this.isReady)}init(){let e=this.config.mode==="hash";window.addEventListener(e?"hashchange":"popstate",this._boundHandleRouteChange);let t=()=>{e&&!window.location.hash?window.location.hash="#/":!e&&window.location.pathname==="/"?this.navigateTo("home"):this.handleRouteChange()};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",t):requestAnimationFrame(t)}handleRouteChange(){let{route:e,queryParams:t}=this._parseCurrentLocation();this.queryManager?.setCurrentQueryParams(t),(e!==this.currentHash||this.queryManager?.hasQueryParamsChanged(t))&&(this.currentHash=e,this.loadRoute(e))}_parseCurrentLocation(){if(this.config.mode==="hash"){let e=window.location.hash.slice(1)||"/",[t,r]=e.split("?"),s="home";return t&&t!=="/"&&(s=t.startsWith("/")?t.slice(1):t),{route:s||"home",queryParams:this.queryManager?.parseQueryString(r||window.location.search.slice(1))||{}}}else{let e=window.location.pathname,t=this.config.basePath||"/",r=e;return t!=="/"&&e.startsWith(t)&&(r=e.slice(t.length)),r.startsWith("/")&&(r=r.slice(1)),{route:r||"home",queryParams:this.queryManager?.parseQueryString(window.location.search.slice(1))||{}}}}async loadRoute(e){if(!this.transitionInProgress)try{if(this.transitionInProgress=!0,this._showProgressBar(),!(this.authManager?await this.authManager.checkAuthentication(e):{allowed:!0,reason:"auth_disabled"}).allowed){this._hideProgressBar(),this.authManager&&(this.authManager.emitAuthEvent("auth_required",{originalRoute:e,loginRoute:this.config.loginRoute}),e!==this.config.loginRoute?this.navigateTo(this.config.loginRoute,{redirect:e}):this.navigateTo(this.config.loginRoute));return}if(!document.getElementById("app"))throw new Error("App element not found");let i=await this.routeLoader.createVueComponent(e);await this.renderComponentWithTransition(i,e),this._hideProgressBar()}catch(r){this._hideProgressBar(),this.log("error",`Route loading failed [${e}]:`,r.message),this.errorHandler?await this.errorHandler.handleRouteError(e,r):console.error("[Router] Critical: No error handler available for route error:",r)}finally{this.transitionInProgress=!1}}async renderComponentWithTransition(e,t){let r=document.getElementById("app");if(!r)return;let s=document.createElement("div");s.className="page-container page-entered",s.id=`page-${t.replace(/\//g,"-")}-${Date.now()}`,r.querySelectorAll(".page-container").forEach(n=>{n.classList.remove("page-entered"),n.classList.add("page-exiting")}),r.appendChild(s);let{createApp:a}=Vue,o=a(e);o.config.globalProperties.$router={navigateTo:(n,l)=>this.navigateTo(n,l),getCurrentRoute:()=>this.getCurrentRoute(),getParams:()=>this.queryManager?.getAllParams()||{},getParam:(n,l)=>this.queryManager?.getParam(n,l),resolvePath:n=>this.resolvePath(n),createComponent:async n=>{try{return await this.routeLoader.createVueComponent(n)}catch(l){throw this.errorHandler&&this.errorHandler.warn("Router",`Failed to create component '${n}':`,l),l}},clearCache:()=>this.cacheManager?.clearAll()||0},o.mount(`#${s.id}`),window.scrollTo(0,0),requestAnimationFrame(()=>{this.cleanupPreviousPages(),this.transitionInProgress=!1}),this.currentVueApp&&(this.previousVueApp=this.currentVueApp),this.currentVueApp=o}cleanupPreviousPages(){let e=document.getElementById("app");if(!e)return;let t=document.createDocumentFragment();if(e.querySelectorAll(".page-container.page-exiting").forEach(s=>s.remove()),this.previousVueApp){try{this.previousVueApp.unmount()}catch{}this.previousVueApp=null}e.querySelector(".loading")?.remove()}_createProgressBar(){let e=document.createElement("div");e.id="viewlogic-progress-bar",e.style.cssText=`
            ...
            z-index: 9999;
            opacity: 0;
        `,document.body.appendChild(e),this.progressBarElement=e}_showProgressBar(){this.progressBarTimer&&clearTimeout(this.progressBarTimer),this.progressBarTimer=setTimeout(()=>{this.progressBarElement&&(this.progressBarElement.style.opacity="1",this.progressBarElement.style.width="70%")},300)}_hideProgressBar(){this.progressBarTimer&&(clearTimeout(this.progressBarTimer),this.progressBarTimer=null),this.progressBarElement&&(this.progressBarElement.style.width="100%",setTimeout(()=>{this.progressBarElement&&(this.progressBarElement.style.opacity="0",this.progressBarElement.style.width="0%")},200))}navigateTo(e,t=null){typeof e=="object"&&(t=e.params||null,e=e.route),typeof e=="string"&&e.startsWith("/")&&(e=e.substring(1)),(!e||e==="")&&(e="home"),e!==this.currentHash&&this.queryManager&&this.queryManager.clearQueryParams(),this.queryManager&&this.queryManager.setCurrentRouteParams(t),this.updateURL(e,t)}getCurrentRoute(){return this.currentHash}updateURL(e,t=null){let r=t||this.queryManager?.getQueryParams()||{},s=this.queryManager?.buildQueryString(r)||"",i=e==="home"?"/":`/${e}`;if(this.config.mode==="hash"){let o=`#${s?`${i}?${s}`:i}`;window.location.hash!==o&&(window.location.hash=o)}else{i=this.combinePaths(this.config.basePath,i);let a=s?`${i}?${s}`:i;window.history.pushState({},"",a),this.handleRouteChange()}}destroy(){window.removeEventListener(this.config.mode==="hash"?"hashchange":"popstate",this._boundHandleRouteChange),this.currentVueApp&&(this.currentVueApp.unmount(),this.currentVueApp=null),this.previousVueApp&&(this.previousVueApp.unmount(),this.previousVueApp=null),Object.values(this).forEach(t=>{t&&typeof t.destroy=="function"&&t.destroy()}),this.cacheManager?.clearAll();let e=document.getElementById("app");e&&(e.innerHTML=""),this.log("info","Router destroyed")}};return k(_);})();
