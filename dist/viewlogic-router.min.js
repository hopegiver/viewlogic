...
${r}`),s}async createVueComponent(e){let t=`component_${e}`,r=this.router.cacheManager?.get(t);if(r)return r;let s=await this.loadScript(e),o=this.router,a=this.config.environment==="production",i,n=null,h=null;if(a)i=s.template||this.generateDefaultTemplate(e);else{let u=[this.loadTemplate(e)];if(this.config.useLayout&&s.layout!==null){let M=s.layout||this.config.defaultLayout;u.push(this.loadLayout(M)),u.push(this.loadLayoutScript(M))}else u.push(Promise.resolve(null)),u.push(Promise.resolve(null));let[c,g,p]=await Promise.all(u);i=c,n=g,h=p,n&&(i=this.mergeLayoutWithTemplate(e,n,i))}let m={};if(this.componentLoader)try{let u=null;if(!a){let c=s.layout||this.config.defaultLayout;u=this.componentLoader.getComponentNames(i,n,c),this.log("debug",`[DEVELOPMENT] Discovered components for route '${e}':`,u)}m=await this.componentLoader.loadAllComponents(u),this.log("debug",`Components loaded successfully for route: ${e}`)}catch(u){this.log("warn",`Component loading failed for route '${e}', continuing without components:`,u.message),m={}}let l=this._mergeLayoutAndPageScript(h,s),f={...l,name:l.name||this.toPascalCase(e),template:i,components:m,data(){let u=l._layoutData?l._layoutData.call(this):{},c=l._pageData?l._pageData.call(this):{};return{...u,...c,currentRoute:e,$query:o.queryManager?.getQueryParams()||{},$params:o.queryManager?.getRouteParams()||{},$lang:(()=>{try{return o.i18nManager?.getCurrentLanguage()||o.config.i18nDefaultLanguage||o.config.defaultLanguage||"ko"}catch(p){return o.errorHandler&&o.errorHandler.warn("RouteLoader","Failed to get current language:",p),o.config.defaultLanguage||"ko"}})(),$dataLoading:!1}},computed:{...l.computed||{},params(){return o.queryManager?.getAllParams()||{}}},async beforeMount(){l._layoutBeforeMount&&await l._layoutBeforeMount.call(this),l._pageBeforeMount&&await l._pageBeforeMount.call(this)},async mounted(){this.$api=o.routeLoader.apiHandler.bindToComponent(this),this.$state=o.stateHandler,l._layoutMounted&&await l._layoutMounted.call(this),l._pageMounted&&await l._pageMounted.call(this),s.dataURL&&await this.fetchData(),await this.$nextTick(),o.routeLoader.formHandler.bindAutoForms(this)},async beforeUpdate(){l._layoutBeforeUpdate&&await l._layoutBeforeUpdate.call(this),l._pageBeforeUpdate&&await l._pageBeforeUpdate.call(this)},async updated(){l._layoutUpdated&&await l._layoutUpdated.call(this),l._pageUpdated&&await l._pageUpdated.call(this)},async beforeUnmount(){l._layoutBeforeUnmount&&await l._layoutBeforeUnmount.call(this),l._pageBeforeUnmount&&await l._pageBeforeUnmount.call(this)},async unmounted(){l._layoutUnmounted&&await l._layoutUnmounted.call(this),l._pageUnmounted&&await l._pageUnmounted.call(this)},methods:{...l.methods,navigateTo:(u,c)=>o.navigateTo(u,c),getCurrentRoute:()=>o.getCurrentRoute(),getParams:()=>o.queryManager?.getAllParams()||{},getParam:(u,c)=>o.queryManager?.getParam(u,c),$t:(u,c)=>{try{return o.i18nManager?.t(u,c)||u}catch(g){return o.errorHandler&&o.errorHandler.warn("RouteLoader","i18n translation failed, returning key:",g),u}},isAuth:()=>o.authManager?.isAuthenticated()||!1,logout:()=>o.authManager?o.navigateTo(o.authManager.logout()):null,getToken:()=>o.authManager?.getAccessToken()||null,setToken:(u,c)=>o.authManager?.setAccessToken(u,c)||!1,getLanguage:()=>o.i18nManager?.getCurrentLanguage()||o.config.defaultLanguage||"ko",setLanguage:u=>o.i18nManager?.setLanguage(u),log:(u,...c)=>{o.errorHandler&&o.errorHandler.log(u,`[${e}]`,...c)},async fetchData(u=null){let c=u||s.dataURL;if(!c)return null;this.$dataLoading=!0;try{if(typeof c=="string"){let g=await o.routeLoader.apiHandler.fetchData(c,this);return Object.assign(this,g),this.$emit("data-loaded",g),g}else if(typeof c=="object"){let{results:g,errors:p}=await o.routeLoader.apiHandler.fetchMultipleData(c,this);return Object.assign(this,g),Object.keys(g).length>0&&this.$emit("data-loaded",g),Object.keys(p).length>0&&this.$emit("data-error",p),g}return null}catch(g){throw o.errorHandler&&o.errorHandler.warn("RouteLoader",`Failed to fetch data for ${e}:`,g),this.$emit("data-error",g),g}finally{this.$dataLoading=!1}}},_routeName:e};return this.router.cacheManager?.set(t,f),f}toPascalCase(e){return e.split(/[-_\s]+/).map(t=>t.charAt(0).toUpperCase()+t.slice(1).toLowerCase()).join("")}generateDefaultTemplate(e){return`<div class="route-${e.replace(/\//g,"-")}"><h1>Route: ${e}</h1></div>`}_mergeLayoutAndPageScript(e,t){return e?{name:t.name||e.name,data:t.data||e.data,_layoutData:e.data,_pageData:t.data,methods:{...e.methods||{},...t.methods||{}},computed:{...e.computed||{},...t.computed||{}},watch:{...e.watch||{},...t.watch||{}},_layoutBeforeMount:e.beforeMount,_pageBeforeMount:t.beforeMount,_layoutMounted:e.mounted,_pageMounted:t.mounted,_layoutBeforeUpdate:e.beforeUpdate,_pageBeforeUpdate:t.beforeUpdate,_layoutUpdated:e.updated,_pageUpdated:t.updated,_layoutBeforeUnmount:e.beforeUnmount,_pageBeforeUnmount:t.beforeUnmount,_layoutUnmounted:e.unmounted,_pageUnmounted:t.unmounted,props:t.props||e.props,emits:t.emits||e.emits,components:{...e.components||{},...t.components||{}},provide:t.provide||e.provide,inject:t.inject||e.inject}:t}log(e,...t){this.router?.errorHandler&&this.router.errorHandler.log(e,"RouteLoader",...t)}destroy(){this.formHandler&&(this.formHandler.destroy(),this.formHandler=null),this.apiHandler&&(this.apiHandler.destroy(),this.apiHandler=null),this.componentLoader&&(this.componentLoader.dispose(),this.componentLoader=null),this.log("debug","RouteLoader destroyed"),this.router=null}};var T=class{constructor(e,t={}){this.config={logLevel:t.logLevel||"info",environment:t.environment||"development"},this.router=e,this.logLevels={error:0,warn:1,info:2,debug:3},this.log("debug","ErrorHandler","ErrorHandler initialized with config:",this.config)}async handleRouteError(e,t){let r=500,s="\uD398\uC774\uC9C0\uB97C \uB85C\uB4DC\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.";this.debug("ErrorHandler","\uC5D0\uB7EC \uC0C1\uC138:",t.message,t.name),t.message.includes("not found")||t.message.includes("404")||t.message.includes("Failed to resolve")||t.message.includes("Failed to fetch")||t.name==="TypeError"&&t.message.includes("resolve")?(r=404,s=`'${e}' \uD398\uC774\uC9C0\uB97C \uCC3E\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.`):t.message.includes("network")&&!t.message.includes("not found")?(r=503,s="\uB124\uD2B8\uC6CC\uD06C \uC5F0\uACB0\uC744 \uD655\uC778\uD574 \uC8FC\uC138\uC694."):(t.message.includes("permission")||t.message.includes("403"))&&(r=403,s="\uD398\uC774\uC9C0\uC5D0 \uC811\uADFC\uD560 \uAD8C\uD55C\uC774 \uC5C6\uC2B5\uB2C8\uB2E4."),this.debug("ErrorHandler",`\uC5D0\uB7EC \uCF54\uB4DC \uACB0\uC815: ${r} (\uB77C\uC6B0\uD2B8: ${e})`),this.reportError(e,t,r);try{r===404?await this.load404Page():await this.loadErrorPage(r,s)}catch(o){this.error("ErrorHandler","\uC5D0\uB7EC \uD398\uC774\uC9C0 \uB85C\uB529 \uC2E4\uD328:",o),this.showFallbackErrorPage(r,s)}}async load404Page(){try{this.info("ErrorHandler","Loading 404 page...");let e=await this.createVueComponent("404");await this.renderComponentWithTransition(e,"404"),this.info("ErrorHandler","404 page loaded successfully")}catch(e){this.error("ErrorHandler","404 page loading failed:",e),this.showFallbackErrorPage("404","\uD398\uC774\uC9C0\uB97C \uCC3E\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.")}}async loadErrorPage(e,t){try{this.info("ErrorHandler",`Loading error page for ${e}...`);let r=await this.createErrorComponent(e,t);await this.renderComponentWithTransition(r,"error"),this.info("ErrorHandler",`Error page ${e} loaded successfully`)}catch(r){this.error("ErrorHandler",`Error page ${e} loading failed:`,r),this.showFallbackErrorPage(e,t)}}async createErrorComponent(e,t){try{let r=await this.createVueComponent("error");return{...r,data(){return{...r.data?r.data():{},errorCode:e,errorMessage:t,showRetry:!0,showGoHome:!0}}}}catch(r){throw this.error("ErrorHandler","Error component load failed:",r),new Error(`Cannot load error page: ${r.message}`)}}showFallbackErrorPage(e,t){let r=document.getElementById("app");if(!r)return;let s=`<div style="text-align:center;padding:2rem;font-family:sans-serif"><h1>${e}</h1><p>${t}</p><button onclick="location.reload()">Retry</button></div>`;r.innerHTML=s,this.info("ErrorHandler",`Fallback error page displayed for ${e}`)}reportError(e,t,r){let s={route:e,errorCode:r,errorMessage:t.message,stack:t.stack,url:window.location.href,userAgent:navigator.userAgent,timestamp:new Date().toISOString(),routerConfig:{environment:this.router?.config?.environment||"unknown",mode:this.router?.config?.mode||"unknown"}};this.error("ErrorHandler","\uB77C\uC6B0\uD130 \uC5D0\uB7EC \uB9AC\uD3EC\uD2B8:",s)}async createVueComponent(e){if(this.router.routeLoader)return await this.router.routeLoader.createVueComponent(e);throw new Error("RouteLoader not available")}async renderComponentWithTransition(e,t){if(this.router.renderComponentWithTransition)return await this.router.renderComponentWithTransition(e,t);throw new Error("Render function not available")}log(e,t,...r){(typeof e!="string"||!this.logLevels.hasOwnProperty(e))&&(r=[t,...r],t=e,e="info");let s=this.logLevels[this.config.logLevel]||this.logLevels.info,o=this.logLevels[e]||this.logLevels.info;if(o>s||this.config.environment==="production"&&o>this.logLevels.warn)return;let a=t?`[${t}]`:"[ViewLogic]",i=new Date().toISOString().substring(11,23);switch(e){case"error":console.error(`${i} ${a}`,...r);break;case"warn":console.warn(`${i} ${a}`,...r);break;case"info":console.info(`${i} ${a}`,...r);break;case"debug":console.log(`${i} ${a}`,...r);break;default:console.log(`${i} ${a}`,...r)}}error(e,...t){this.log("error",e,...t)}warn(e,...t){this.log("warn",e,...t)}info(e,...t){this.log("info",e,...t)}debug(e,...t){this.log("debug",e,...t)}destroy(){this.router=null,this.info("ErrorHandler","ErrorHandler destroyed")}};var R=class{constructor(e){this.router=e,this.state={},this.listeners=new Map,this.log("debug","StateHandler initialized")}log(e,...t){this.router?.errorHandler&&this.router.errorHandler.log(e,"StateHandler",...t)}set(e,t){let r=this.state[e];return this.state[e]=t,this.emitChange(e,t,r),this.log("debug",`State set: ${e}`,t),t}get(e,t=void 0){let r=this.state.hasOwnProperty(e)?this.state[e]:t;return this.log("debug",`State get: ${e}`,r),r}has(e){return this.state.hasOwnProperty(e)}delete(e){if(this.has(e)){let t=this.state[e];return delete this.state[e],this.emitChange(e,void 0,t),this.log("debug",`State deleted: ${e}`),!0}return!1}clear(){let e=Object.keys(this.state);return this.state={},e.forEach(t=>{this.emitChange(t,void 0,this.state[t])}),this.log("debug","All state cleared"),e.length}update(e){if(!e||typeof e!="object"){this.log("warn","Invalid updates object provided");return}Object.entries(e).forEach(([t,r])=>{this.set(t,r)})}getAll(){return{...this.state}}watch(e,t){this.listeners.has(e)||this.listeners.set(e,[]),this.listeners.get(e).push(t),this.log("debug",`Watcher added for: ${e}`)}unwatch(e,t){if(this.listeners.has(e)){let r=this.listeners.get(e),s=r.indexOf(t);s>-1&&(r.splice(s,1),this.log("debug",`Watcher removed for: ${e}`))}}emitChange(e,t,r){this.listeners.has(e)&&this.listeners.get(e).forEach(s=>{try{s(t,r,e)}catch(o){this.log("error","State watcher error:",o)}})}getStats(){return{stateCount:Object.keys(this.state).length,watcherCount:Array.from(this.listeners.values()).reduce((e,t)=>e+t.length,0),keys:Object.keys(this.state)}}destroy(){this.state={},this.listeners.clear(),this.log("debug","StateHandler destroyed")}};var E=class{constructor(e={}){this.version=e.version||"1.0.0",this.config=this._buildConfig(e),this.currentHash="",this.currentVueApp=null,this.previousVueApp=null,this.transitionInProgress=!1,this.progressBarTimer=null,this.progressBarElement=null,this.isReady=!1,this.readyPromise=null,this._boundHandleRouteChange=this.handleRouteChange.bind(this),this.readyPromise=this.initialize()}_buildConfig(e){let t=window.location.origin,s={...{basePath:"/",srcPath:"/src",mode:"hash",cacheMode:"memory",cacheTTL:3e5,maxCacheSize:50,useLayout:!0,defaultLayout:"default",defaultRoute:"home",environment:"development",routesPath:"/routes",enableErrorReporting:!0,useI18n:!1,defaultLanguage:"ko",i18nPath:"/i18n",logLevel:"info",apiBaseURL:"",requestTimeout:3e4,uploadTimeout:3e5,authEnabled:!1,loginRoute:"login",protectedRoutes:[],protectedPrefixes:[],publicRoutes:["login","register","home"],checkAuthFunction:null,redirectAfterLogin:"home",authCookieName:"authToken",authStorage:"localStorage"},...e};return s.srcPath=this.resolvePath(s.srcPath,s.basePath),s.routesPath=this.resolvePath(s.routesPath,s.basePath),s.i18nPath=this.resolvePath(s.i18nPath,s.basePath),s}combinePaths(e,t){if(!e||e==="/")return t.replace(/\/+/g,"/");let r=e.endsWith("/")?e.slice(0,-1):e,s=t.startsWith("/")?t:`/${t}`;return`${r}${s}`.replace(/\/+/g,"/")}resolvePath(e,t=null){t===null&&(t=this.config?.basePath||"/");let r=window.location.origin;if(e.startsWith("http"))return e;if(e.startsWith("/")){let i=this.combinePaths(t,e);return`${r}${i}`}let s=window.location.pathname,o=s.endsWith("/")?s:s.substring(0,s.lastIndexOf("/")+1),a=this.combinePaths(o,e);return`${r}${a}`}log(e,...t){this.errorHandler&&this.errorHandler.log(e,"Router",...t)}async initialize(){try{if(this.cacheManager=new w(this,this.config),this.stateHandler=new R(this),this.routeLoader=new v(this,this.config),this.queryManager=new P(this),this.errorHandler=new T(this,this.config),this.config.useI18n)try{this.i18nManager=new y(this,this.config),this.i18nManager.initPromise&&await this.i18nManager.initPromise,this.log("info","I18nManager initialized successfully")}catch(e){this.log("warn","I18nManager initialization failed, continuing without i18n:",e.message),this.i18nManager=null,this.config.useI18n=!1}this.config.authEnabled&&(this.authManager=new b(this,this.config)),this._createProgressBar(),this.isReady=!0,this.init()}catch(e){this.log("error","Router initialization failed:",e),this.isReady=!0,this.init()}}async waitForReady(){return this.isReady?!0:(this.readyPromise&&await this.readyPromise,this.isReady)}init(){let e=this.config.mode==="hash";window.addEventListener(e?"hashchange":"popstate",this._boundHandleRouteChange);let t=()=>{e&&!window.location.hash?window.location.hash="#/":!e&&window.location.pathname==="/"?this.navigateTo(this.config.defaultRoute):this.handleRouteChange()};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",t):requestAnimationFrame(t)}handleRouteChange(){let{route:e,queryParams:t}=this._parseCurrentLocation();this.queryManager?.setCurrentQueryParams(t),(e!==this.currentHash||this.queryManager?.hasQueryParamsChanged(t))&&(this.currentHash=e,this.loadRoute(e))}_parseCurrentLocation(){if(this.config.mode==="hash"){let e=window.location.hash.slice(1)||"/",[t,r]=e.split("?"),s=this.config.defaultRoute;return t&&t!=="/"&&(s=t.startsWith("/")?t.slice(1):t),{route:s||this.config.defaultRoute,queryParams:this.queryManager?.parseQueryString(r||window.location.search.slice(1))||{}}}else{let e=window.location.pathname,t=this.config.basePath||"/",r=e;return t!=="/"&&e.startsWith(t)&&(r=e.slice(t.length)),r.startsWith("/")&&(r=r.slice(1)),{route:r||this.config.defaultRoute,queryParams:this.queryManager?.parseQueryString(window.location.search.slice(1))||{}}}}async loadRoute(e){if(!this.transitionInProgress)try{if(this.transitionInProgress=!0,this._showProgressBar(),!(this.authManager?await this.authManager.checkAuthentication(e):{allowed:!0,reason:"auth_disabled"}).allowed){this._hideProgressBar(),this.authManager&&(this.authManager.emitAuthEvent("auth_required",{originalRoute:e,loginRoute:this.config.loginRoute}),e!==this.config.loginRoute?this.navigateTo(this.config.loginRoute,{redirect:e}):this.navigateTo(this.config.loginRoute));return}if(!document.getElementById("app"))throw new Error("App element not found");let o=await this.routeLoader.createVueComponent(e);await this.renderComponentWithTransition(o,e),this._hideProgressBar()}catch(r){this._hideProgressBar(),this.log("error",`Route loading failed [${e}]:`,r.message),this.errorHandler?await this.errorHandler.handleRouteError(e,r):console.error("[Router] Critical: No error handler available for route error:",r)}finally{this.transitionInProgress=!1}}async renderComponentWithTransition(e,t){let r=document.getElementById("app");if(!r)return;let s=document.createElement("div");s.className="page-container page-entered",s.id=`page-${t.replace(/\//g,"-")}-${Date.now()}`,r.querySelectorAll(".page-container").forEach(n=>{n.classList.remove("page-entered"),n.classList.add("page-exiting")}),r.appendChild(s);let{createApp:a}=Vue,i=a(e);i.config.globalProperties.$router={navigateTo:(n,h)=>this.navigateTo(n,h),getCurrentRoute:()=>this.getCurrentRoute(),getParams:()=>this.queryManager?.getAllParams()||{},getParam:(n,h)=>this.queryManager?.getParam(n,h),resolvePath:n=>this.resolvePath(n),createComponent:async n=>{try{return await this.routeLoader.createVueComponent(n)}catch(h){throw this.errorHandler&&this.errorHandler.warn("Router",`Failed to create component '${n}':`,h),h}},clearCache:()=>this.cacheManager?.clearAll()||0},i.mount(`#${s.id}`),window.scrollTo(0,0),requestAnimationFrame(()=>{this.cleanupPreviousPages(),this.transitionInProgress=!1}),this.currentVueApp&&(this.previousVueApp=this.currentVueApp),this.currentVueApp=i}cleanupPreviousPages(){let e=document.getElementById("app");if(!e)return;let t=document.createDocumentFragment();if(e.querySelectorAll(".page-container.page-exiting").forEach(s=>s.remove()),this.previousVueApp){try{this.previousVueApp.unmount()}catch{}this.previousVueApp=null}e.querySelector(".loading")?.remove()}_createProgressBar(){let e=document.createElement("div");e.id="viewlogic-progress-bar",e.style.cssText=`
            ...
            z-index: 9999;
            opacity: 0;
        `,document.body.appendChild(e),this.progressBarElement=e}_showProgressBar(){this.progressBarTimer&&clearTimeout(this.progressBarTimer),this.progressBarTimer=setTimeout(()=>{this.progressBarElement&&(this.progressBarElement.style.opacity="1",this.progressBarElement.style.width="70%")},300)}_hideProgressBar(){this.progressBarTimer&&(clearTimeout(this.progressBarTimer),this.progressBarTimer=null),this.progressBarElement&&(this.progressBarElement.style.width="100%",setTimeout(()=>{this.progressBarElement&&(this.progressBarElement.style.opacity="0",this.progressBarElement.style.width="0%")},200))}navigateTo(e,t=null){typeof e=="object"&&(t=e.params||null,e=e.route),typeof e=="string"&&e.startsWith("/")&&(e=e.substring(1)),(!e||e==="")&&(e=this.config.defaultRoute),e!==this.currentHash&&this.queryManager&&this.queryManager.clearQueryParams(),this.queryManager&&this.queryManager.setCurrentRouteParams(t),this.updateURL(e,t)}getCurrentRoute(){return this.currentHash}updateURL(e,t=null){let r=t||this.queryManager?.getQueryParams()||{},s=this.queryManager?.buildQueryString(r)||"",o=e===this.config.defaultRoute?"/":`/${e}`;if(this.config.mode==="hash"){let i=`#${s?`${o}?${s}`:o}`;window.location.hash!==i&&(window.location.hash=i)}else{o=this.combinePaths(this.config.basePath,o);let a=s?`${o}?${s}`:o;window.history.pushState({},"",a),this.handleRouteChange()}}destroy(){window.removeEventListener(this.config.mode==="hash"?"hashchange":"popstate",this._boundHandleRouteChange),this.currentVueApp&&(this.currentVueApp.unmount(),this.currentVueApp=null),this.previousVueApp&&(this.previousVueApp.unmount(),this.previousVueApp=null),Object.values(this).forEach(t=>{t&&typeof t.destroy=="function"&&t.destroy()}),this.cacheManager?.clearAll();let e=document.getElementById("app");e&&(e.innerHTML=""),this.log("info","Router destroyed")}};return x(U);})();
